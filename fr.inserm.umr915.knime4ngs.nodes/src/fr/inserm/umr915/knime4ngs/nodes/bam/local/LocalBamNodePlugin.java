 ...
 */
public class LocalBamNodePlugin extends Plugin {
    // The shared instance.
    private static LocalBamNodePlugin plugin;

    /**
     * The constructor.
     */
    public LocalBamNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static LocalBamNodePlugin getDefault() {
        return plugin;
    }
