 ...
 */
public class  BedInterBedNodePlugin extends Plugin {
    // The shared instance.
    private static  BedInterBedNodePlugin plugin;

    /**
     * The constructor.
     */
    public  BedInterBedNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  BedInterBedNodePlugin getDefault() {
        return plugin;
    }
