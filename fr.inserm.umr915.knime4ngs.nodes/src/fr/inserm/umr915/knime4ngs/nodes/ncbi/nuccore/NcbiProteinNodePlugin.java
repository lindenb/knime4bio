 ...
 */
public class  NcbiProteinNodePlugin extends Plugin {
    // The shared instance.
    private static  NcbiProteinNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NcbiProteinNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NcbiProteinNodePlugin getDefault() {
        return plugin;
    }
