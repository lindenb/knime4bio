 ...
 */
public class  NcbiPubmedNodePlugin extends Plugin {
    // The shared instance.
    private static  NcbiPubmedNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NcbiPubmedNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NcbiPubmedNodePlugin getDefault() {
        return plugin;
    }
