 ...
 */
public class  NcbiSnpNodePlugin extends Plugin {
    // The shared instance.
    private static  NcbiSnpNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NcbiSnpNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NcbiSnpNodePlugin getDefault() {
        return plugin;
    }
