 ...
 */
public class  NumColumnFilterNodePlugin extends Plugin {
    // The shared instance.
    private static  NumColumnFilterNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NumColumnFilterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NumColumnFilterNodePlugin getDefault() {
        return plugin;
    }
