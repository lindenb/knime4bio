 ...
 */
public class  BigBedFileNodePlugin extends Plugin {
    // The shared instance.
    private static  BigBedFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public  BigBedFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  BigBedFileNodePlugin getDefault() {
        return plugin;
    }
