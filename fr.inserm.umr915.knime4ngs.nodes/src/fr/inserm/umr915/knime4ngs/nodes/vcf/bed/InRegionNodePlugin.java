 ...
 */
public class  InRegionNodePlugin extends Plugin {
    // The shared instance.
    private static  InRegionNodePlugin plugin;

    /**
     * The constructor.
     */
    public  InRegionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  InRegionNodePlugin getDefault() {
        return plugin;
    }
