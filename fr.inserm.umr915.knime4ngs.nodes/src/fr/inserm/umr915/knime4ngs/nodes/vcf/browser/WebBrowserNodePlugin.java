 ...
 */
public class WebBrowserNodePlugin extends Plugin {
    // The shared instance.
    private static WebBrowserNodePlugin plugin;

    /**
     * The constructor.
     */
    public WebBrowserNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WebBrowserNodePlugin getDefault() {
        return plugin;
    }
