 ...
 */
public class  NormalizeChromNodePlugin extends Plugin {
    // The shared instance.
    private static  NormalizeChromNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NormalizeChromNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NormalizeChromNodePlugin getDefault() {
        return plugin;
    }
