 ...
 */
public class  DasContextNodePlugin extends Plugin {
    // The shared instance.
    private static  DasContextNodePlugin plugin;

    /**
     * The constructor.
     */
    public  DasContextNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  DasContextNodePlugin getDefault() {
        return plugin;
    }
