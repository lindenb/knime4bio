 ...
 */
public class  DasFeaturesNodePlugin extends Plugin {
    // The shared instance.
    private static  DasFeaturesNodePlugin plugin;

    /**
     * The constructor.
     */
    public  DasFeaturesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  DasFeaturesNodePlugin getDefault() {
        return plugin;
    }
