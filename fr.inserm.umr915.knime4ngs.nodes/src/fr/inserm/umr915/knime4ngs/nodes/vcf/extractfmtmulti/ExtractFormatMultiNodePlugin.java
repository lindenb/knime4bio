 ...
 */
public class  ExtractFormatMultiNodePlugin extends Plugin {
    // The shared instance.
    private static  ExtractFormatMultiNodePlugin plugin;

    /**
     * The constructor.
     */
    public  ExtractFormatMultiNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  ExtractFormatMultiNodePlugin getDefault() {
        return plugin;
    }
