 ...
 */
public class  ExtractInfoNodePlugin extends Plugin {
    // The shared instance.
    private static  ExtractInfoNodePlugin plugin;

    /**
     * The constructor.
     */
    public  ExtractInfoNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  ExtractInfoNodePlugin getDefault() {
        return plugin;
    }
