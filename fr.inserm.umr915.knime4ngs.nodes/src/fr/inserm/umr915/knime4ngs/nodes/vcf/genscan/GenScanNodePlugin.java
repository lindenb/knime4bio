 ...
 */
public class GenScanNodePlugin extends Plugin {
    // The shared instance.
    private static GenScanNodePlugin plugin;

    /**
     * The constructor.
     */
    public GenScanNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GenScanNodePlugin getDefault() {
        return plugin;
    }
