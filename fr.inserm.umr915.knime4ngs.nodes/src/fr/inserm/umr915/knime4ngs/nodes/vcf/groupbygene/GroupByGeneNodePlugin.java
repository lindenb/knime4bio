 ...
 */
public class  GroupByGeneNodePlugin extends Plugin {
    // The shared instance.
    private static  GroupByGeneNodePlugin plugin;

    /**
     * The constructor.
     */
    public  GroupByGeneNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  GroupByGeneNodePlugin getDefault() {
        return plugin;
    }
