 ...
 */
public class  GroupBySnpNodePlugin extends Plugin {
    // The shared instance.
    private static  GroupBySnpNodePlugin plugin;

    /**
     * The constructor.
     */
    public  GroupBySnpNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  GroupBySnpNodePlugin getDefault() {
        return plugin;
    }
