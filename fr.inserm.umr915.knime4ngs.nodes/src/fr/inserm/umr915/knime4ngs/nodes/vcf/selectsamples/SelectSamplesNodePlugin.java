 ...
 */
public class  SelectSamplesNodePlugin extends Plugin {
    // The shared instance.
    private static  SelectSamplesNodePlugin plugin;

    /**
     * The constructor.
     */
    public  SelectSamplesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  SelectSamplesNodePlugin getDefault() {
        return plugin;
    }
