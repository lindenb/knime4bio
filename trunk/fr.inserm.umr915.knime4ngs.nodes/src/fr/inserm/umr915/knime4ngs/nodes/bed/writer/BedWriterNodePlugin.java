 ...
 */
public class  BedWriterNodePlugin extends Plugin {
    // The shared instance.
    private static  BedWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public  BedWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  BedWriterNodePlugin getDefault() {
        return plugin;
    }
