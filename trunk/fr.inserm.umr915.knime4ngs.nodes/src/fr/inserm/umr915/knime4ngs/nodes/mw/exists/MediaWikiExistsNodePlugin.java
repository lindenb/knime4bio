 ...
 */
public class MediaWikiExistsNodePlugin extends Plugin {
    // The shared instance.
    private static MediaWikiExistsNodePlugin plugin;

    /**
     * The constructor.
     */
    public MediaWikiExistsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MediaWikiExistsNodePlugin getDefault() {
        return plugin;
    }
