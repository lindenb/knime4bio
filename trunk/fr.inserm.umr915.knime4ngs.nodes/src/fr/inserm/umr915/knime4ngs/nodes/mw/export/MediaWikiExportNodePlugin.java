 ...
 */
public class MediaWikiExportNodePlugin extends Plugin {
    // The shared instance.
    private static MediaWikiExportNodePlugin plugin;

    /**
     * The constructor.
     */
    public MediaWikiExportNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MediaWikiExportNodePlugin getDefault() {
        return plugin;
    }
