 ...
 */
public class  ArticleCitedNodePlugin extends Plugin {
    // The shared instance.
    private static  ArticleCitedNodePlugin plugin;

    /**
     * The constructor.
     */
    public  ArticleCitedNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  ArticleCitedNodePlugin getDefault() {
        return plugin;
    }
