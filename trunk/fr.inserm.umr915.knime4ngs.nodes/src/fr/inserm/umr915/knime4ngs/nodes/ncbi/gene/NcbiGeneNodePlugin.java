 ...
 */
public class  NcbiGeneNodePlugin extends Plugin {
    // The shared instance.
    private static  NcbiGeneNodePlugin plugin;

    /**
     * The constructor.
     */
    public  NcbiGeneNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  NcbiGeneNodePlugin getDefault() {
        return plugin;
    }
