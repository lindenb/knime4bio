 ...
 */
public class NcbiViewNodePlugin extends Plugin {
    // The shared instance.
    private static NcbiViewNodePlugin plugin;

    /**
     * The constructor.
     */
    public NcbiViewNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NcbiViewNodePlugin getDefault() {
        return plugin;
    }
