 ...
 */
public class  SqlQueryNodePlugin extends Plugin {
    // The shared instance.
    private static  SqlQueryNodePlugin plugin;

    /**
     * The constructor.
     */
    public  SqlQueryNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  SqlQueryNodePlugin getDefault() {
        return plugin;
    }
