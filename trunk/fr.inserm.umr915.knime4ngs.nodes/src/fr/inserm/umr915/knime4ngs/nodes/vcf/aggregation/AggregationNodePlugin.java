 ...
 */
public class  AggregationNodePlugin extends Plugin {
    // The shared instance.
    private static  AggregationNodePlugin plugin;

    /**
     * The constructor.
     */
    public  AggregationNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  AggregationNodePlugin getDefault() {
        return plugin;
    }
