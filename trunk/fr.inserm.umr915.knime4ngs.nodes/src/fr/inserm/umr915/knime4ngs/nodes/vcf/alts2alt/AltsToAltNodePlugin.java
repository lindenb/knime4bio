 ...
 */
public class  AltsToAltNodePlugin extends Plugin {
    // The shared instance.
    private static  AltsToAltNodePlugin plugin;

    /**
     * The constructor.
     */
    public  AltsToAltNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  AltsToAltNodePlugin getDefault() {
        return plugin;
    }
