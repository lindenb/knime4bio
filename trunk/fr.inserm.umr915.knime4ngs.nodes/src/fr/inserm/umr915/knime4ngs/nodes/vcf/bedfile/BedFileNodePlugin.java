 ...
 */
public class  BedFileNodePlugin extends Plugin {
    // The shared instance.
    private static  BedFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public  BedFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  BedFileNodePlugin getDefault() {
        return plugin;
    }
