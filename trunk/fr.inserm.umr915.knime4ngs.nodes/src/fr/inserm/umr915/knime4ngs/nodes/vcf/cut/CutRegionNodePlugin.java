 ...
 */
public class  CutRegionNodePlugin extends Plugin {
    // The shared instance.
    private static  CutRegionNodePlugin plugin;

    /**
     * The constructor.
     */
    public  CutRegionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  CutRegionNodePlugin getDefault() {
        return plugin;
    }
