 ...
 */
public class  DistanceSnpNodePlugin extends Plugin {
    // The shared instance.
    private static  DistanceSnpNodePlugin plugin;

    /**
     * The constructor.
     */
    public  DistanceSnpNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  DistanceSnpNodePlugin getDefault() {
        return plugin;
    }
