 ...
 */
public class  ExtractFormatNodePlugin extends Plugin {
    // The shared instance.
    private static  ExtractFormatNodePlugin plugin;

    /**
     * The constructor.
     */
    public  ExtractFormatNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  ExtractFormatNodePlugin getDefault() {
        return plugin;
    }
