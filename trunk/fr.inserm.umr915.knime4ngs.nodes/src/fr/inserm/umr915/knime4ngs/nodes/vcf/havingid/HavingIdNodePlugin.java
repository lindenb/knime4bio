 ...
 */
public class  HavingIdNodePlugin extends Plugin {
    // The shared instance.
    private static  HavingIdNodePlugin plugin;

    /**
     * The constructor.
     */
    public  HavingIdNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  HavingIdNodePlugin getDefault() {
        return plugin;
    }
