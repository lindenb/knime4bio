 ...
 */
public class  JoinPosNodePlugin extends Plugin {
    // The shared instance.
    private static  JoinPosNodePlugin plugin;

    /**
     * The constructor.
     */
    public  JoinPosNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  JoinPosNodePlugin getDefault() {
        return plugin;
    }
