 ...
 */
public class  VCFNumericSplitNodePlugin extends Plugin {
    // The shared instance.
    private static  VCFNumericSplitNodePlugin plugin;

    /**
     * The constructor.
     */
    public  VCFNumericSplitNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  VCFNumericSplitNodePlugin getDefault() {
        return plugin;
    }
