 ...
 */
public class LocalUcscPredictionNodePlugin extends Plugin {
    // The shared instance.
    private static LocalUcscPredictionNodePlugin plugin;

    /**
     * The constructor.
     */
    public LocalUcscPredictionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static LocalUcscPredictionNodePlugin getDefault() {
        return plugin;
    }
