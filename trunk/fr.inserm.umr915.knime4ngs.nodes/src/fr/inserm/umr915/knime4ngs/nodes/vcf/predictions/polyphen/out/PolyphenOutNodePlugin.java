 ...
 */
public class PolyphenOutNodePlugin extends Plugin {
    // The shared instance.
    private static PolyphenOutNodePlugin plugin;

    /**
     * The constructor.
     */
    public PolyphenOutNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PolyphenOutNodePlugin getDefault() {
        return plugin;
    }
