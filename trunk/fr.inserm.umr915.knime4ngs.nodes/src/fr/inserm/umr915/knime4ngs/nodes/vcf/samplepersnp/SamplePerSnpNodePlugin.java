 ...
 */
public class  SamplePerSnpNodePlugin extends Plugin {
    // The shared instance.
    private static  SamplePerSnpNodePlugin plugin;

    /**
     * The constructor.
     */
    public  SamplePerSnpNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  SamplePerSnpNodePlugin getDefault() {
        return plugin;
    }
