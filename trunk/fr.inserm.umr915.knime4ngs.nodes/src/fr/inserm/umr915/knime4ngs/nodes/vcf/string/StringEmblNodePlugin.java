 ...
 */
public class  StringEmblNodePlugin extends Plugin {
    // The shared instance.
    private static  StringEmblNodePlugin plugin;

    /**
     * The constructor.
     */
    public  StringEmblNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  StringEmblNodePlugin getDefault() {
        return plugin;
    }
