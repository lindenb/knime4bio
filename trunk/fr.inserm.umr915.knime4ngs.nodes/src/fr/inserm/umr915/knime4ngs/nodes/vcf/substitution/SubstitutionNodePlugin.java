 ...
 */
public class SubstitutionNodePlugin extends Plugin {
    // The shared instance.
    private static SubstitutionNodePlugin plugin;

    /**
     * The constructor.
     */
    public SubstitutionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SubstitutionNodePlugin getDefault() {
        return plugin;
    }
