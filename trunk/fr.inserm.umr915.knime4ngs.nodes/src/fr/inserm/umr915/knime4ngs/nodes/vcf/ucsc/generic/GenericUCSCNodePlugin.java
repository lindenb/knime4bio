 ...
 */
public class  GenericUCSCNodePlugin extends Plugin {
    // The shared instance.
    private static  GenericUCSCNodePlugin plugin;

    /**
     * The constructor.
     */
    public  GenericUCSCNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  GenericUCSCNodePlugin getDefault() {
        return plugin;
    }
