 ...
 */
public class  MysqlUCSCNodePlugin extends Plugin {
    // The shared instance.
    private static  MysqlUCSCNodePlugin plugin;

    /**
     * The constructor.
     */
    public  MysqlUCSCNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static  MysqlUCSCNodePlugin getDefault() {
        return plugin;
    }
